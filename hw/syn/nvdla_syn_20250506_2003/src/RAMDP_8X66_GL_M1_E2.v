//-----------------------------------------------------------------------------
// DFF-based synthesizable wrapper for RAMDP_8X66_GL_M1_E2.v
...
module RAMDP_8X66_GL_M1_E2 (
  ...
  // read address bits
  input  wire  RADR_2, RADR_1, RADR_0,
  // write address bits
  input  wire  WADR_2, WADR_1, WADR_0,
  ...
  // buses
  wire [ADDR_WIDTH-1:0] RA     = {RADR_2, RADR_1, RADR_0};
  wire [ADDR_WIDTH-1:0] WA     = {WADR_2, WADR_1, WADR_0};
